# 🧠 Engineering Knowledge Base | Mi Base de Conocimiento
# 🧠 Repositorio de Notas de Ingeniería
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/ProjectStatus-In%20Progress-yellow?style=for-the-badge" alt="ProjectStatus">
</p>
...
**EN:** This repository serves as a professional documentation of my learning journey in **Information Systems Engineering**. Here, I organize my academic notes, book summaries, and technical insights to consolidate my knowledge and share resources with the community.
...
Current focus (3rd Year):
*Enfoque actual (3er Año):*

* **Software Engineering:** Design patterns, architecture, and development lifecycles.
* **Data Analysis:** Statistical processing and visualization (Python, Power BI).
* **Backend Development:** Deep dive into NestJS, Node.js, and SQL databases.
* **Operating Systems:** Process management, memory, and networking.

---

## 📖 Book Summaries | Resúmenes de Libros

**EN:** To respect copyright, this repository **does not contain original PDF files**. Instead, it hosts my personal notes and key takeaways from each title.
**ES:** Para respetar los derechos de autor, este repositorio **no contiene archivos PDF originales**. En su lugar, aloja mis notas personales y aprendizajes clave de cada título.
